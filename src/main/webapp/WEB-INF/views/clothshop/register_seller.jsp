		...
		<div class="row">
			...
			<div class="col-lg-6 col-log-6_registerForm">
				<div class="login_form_inner register_form_inner" style="">
					...
					<form class="row login_form" action="register_seller" id="register_form" method="post">
							<div class="col-md-12 form-group" style="margin-bottom:1px">
								<span class="input-group-btn" style="display:flex;flex-direction:row;">		
									<input type="text" class="form-control" id="user_id" name="s_id" placeholder="UserID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'UserID'"> <button class="btn btn-default" id="idok" type="button" style="float:right;">확인</button>
								</span>
							</div>
							...
							<div class="col-md-12 form-group">
				              ...
				              <div class="col-md-12 form-group" style="margin-bottom:1px">				              		
								<span class="input-group-btn" style="display:flex;flex-direction:row;">
									<input style="" type="text" class="form-control" id="password" name="s_pw" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'"> <button class="btn btn-default" id="pwok" type="button" style="float:right;">확인</button>
	     						</span>
				              </div>
				            <div class="textMessageBox" style="padding-left:15px">
